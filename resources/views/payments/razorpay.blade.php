        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-6">
                            <a class="theme-btn d-block text-center" href="{{ route('payment.failed', ['status' => 'failed', 'message' => 'Subscription order cancelled']) }}"><i class="fas fa-arrow-left"></i> {{ __('Go Back') }}</a>
                        </div>
