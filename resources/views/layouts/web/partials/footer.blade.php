    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-md-6 col-lg-5">
                <a href="{{ route('home') }}">
                    <img src="{{ asset_with_fallback($page_data['web_logo_one'] ?? null, 'assets/images/logo/frontend_logo.svg') }}" alt="footer-logo" class="footer-logo" />
                </a>
                    ...
                    @foreach ($page_data['headings']['footer_socials_links'] ?? [] as $key => $footer_socials_link)
                        <li>
                            <a href="{{ url($footer_socials_link) }}" target="_blank">
                                <img src="{{ asset_with_fallback($page_data['footer_socials_icons'][$key] ?? null, 'assets/web/images/icons/social.svg') }}" alt="icon">
                            </a>
                        </li>
                    @endforeach
                </ul>
