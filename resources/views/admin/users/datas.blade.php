@foreach ($users as $user)
    <tr class="table-content">
        ...
        <td class="text-start table-single-content">{{ ($users->perPage() * ($users->currentPage() - 1)) + $loop->iteration }}</td>
        <td class="text-center table-single-content">{{ formatted_date($user->created_at) }}</td>
        <td class="text-center table-single-content">{{ $user->name }}</td>
        <td class="text-center table-single-content">{{ $user->phone }}</td>
        <td class="text-center table-single-content">{{ $user->email }}</td>
        <td class="text-center table-single-content">{{ $user->role }}</td>
