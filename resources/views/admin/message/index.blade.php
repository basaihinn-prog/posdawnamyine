                    ...
                    <table class="table" id="datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="table-header-content text-center"> {{ __('Name') }} </th>
                                <th class="table-header-content text-center"> {{ __('Phone') }} </th>
                                <th class="table-header-content text-center"> {{ __('Email') }} </th>
                                <th class="table-header-content text-center"> {{ __('Company Name') }} </th>
                                <th class="table-header-content text-center"> {{ __('Message') }} </th>
