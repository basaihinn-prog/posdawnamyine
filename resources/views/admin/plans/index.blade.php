            ...
            <div class="responsive-table table-container">
                <table class="table" id="datatable">
                    ...
                    <tr>
                        ...
                        <th class="table-header-content text-center">{{ __('Subscription Name') }}</th>
                        <th class="table-header-content text-center">{{ __('Icon') }}</th>
                        <th class="table-header-content text-center">{{ __('Duration') }}</th>
                        <th class="table-header-content text-center">{{ __('Offer Price') }}</th>
                        <th class="table-header-content text-center">{{ __('Subscription Price') }}</th>
                        <th class="table-header-content text-center">{{ __('Status') }}</th>
                        <th class="table-header-content text-center">{{ __('Popular') }}</th>
                        <th class="table-header-content d-print-none text-center">{{ __('Action') }}</th>
                    </tr>
                    </thead>
                    <tbody id="plans-data">
