@foreach($plans as $plan)
    <tr class="table-content">
        ...
        @endcan
        <td class="table-single-content text-start">{{ ($plans->perPage() * ($plans->currentPage() - 1)) + $loop->iteration }}</td>
        <td  class="text-center table-single-content">{{ $plan->subscriptionName }} </td>
        <td>
