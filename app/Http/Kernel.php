...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'chef' =>  \App\Http\Middleware\KitchenMiddleware::class,
        ...
        'admin.lang'  => \App\Http\Middleware\SetAdminLocale::class,
        'restaurant.lang'  => \App\Http\Middleware\SetLocale::class,
        'store.lang'  => \App\Http\Middleware\SetOnlineStoreLocale::class,
    ];
}
