...
class AcnooKotReportController extends Controller
{
    ...
    {
        $this->middleware('check.permission:kotReport.view')->only('index');
    }
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return response()->json([
                'data' => view('restaurantwebaddon::kot-reports.datas', compact('kots'))->render(),
            ]);
        }

        return view('restaurantwebaddon::kot-reports.index', compact('kots'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $pdf = Pdf::loadView('restaurantwebaddon::kot-reports.pdf', compact('kots', 'from_date', 'to_date', 'duration'));
