                            ...
                            <div class="kot-item">
                                ...
                                @if ($item->cooking_status === 'pending')
                                    <button class="item-action-btn kot-start-btn"
                                        data-url="{{ route('kitchen.kots-cooking-status', $item->id) }}"
                ...
                <div class="kot-footer-btns">
                    @if ($kot->kot_ticket?->status != 'cancelled')
                        <button class="kot-cancel-btn"
                            data-url="{{ route('kitchen.kots-kot-status', $kot->kot_ticket?->id) }}">
                            {{__('Cancel')}}
                        </button>
                        ...
                        @endif
                    @endif
                    <a href="{{ route('kitchen.kots.get-ticket', $kot->id) }}" target="blank" class="kot-print-btn">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
