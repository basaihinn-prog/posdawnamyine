                         ...
                         <div class="col-md-6">
                            <div class="custom-dropdown-2 gpt-up-down-arrow">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <div class="dropdown-item tableSelect" data-id="{{ $table->id }}">
                                        {{ $table->name }}
                                        @if ($table->is_booked == 1)
                                        <div class="hold">{{__('Running')}}</div>
                                        @endif
                                    </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="bottom-amount-section">
                         <div class="payment-container">
                            ...
                            <div class="payment-container">
                                ...
                                <button type="submit" class="payment-footer w-100 submit-btn {{ empty($vat_on_sale) ? 'no-pay-row' : '' }}" id="paymentBtnHide" name="is_payment" value="1">
                                    <div class="badge-box totalCartProduct">0</div>
                                    <p  class="footer-label">{{__('Payment')}}:</p>
                                    <span class="pay-amount totalAmmount"></span>
                                </button>
                                <button class="payment-footer w-100 {{ empty($vat_on_sale) ? 'no-pay-row' : '' }}" id="saveBtn">
                                    <div class="badge-box totalCartProduct">0</div>
