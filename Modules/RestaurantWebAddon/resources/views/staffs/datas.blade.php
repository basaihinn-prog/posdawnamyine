@foreach ($staffs as $staff)
    <tr>
        ...
        @endusercan
        <td class="text-start">{{ ($staffs->currentPage() - 1) * $staffs->perPage() + $loop->iteration }}</td>
        <td class="text-start"><img src="{{ asset($staff->image ?? 'assets/img/icon/no-image.svg') }}" alt="Img" class="table-img"></td>
            ...
            <div class="d-flex align-items-center justify-content-end">
                <div class="icon-buttons">
                    ...
                    <a title="{{__('View')}}" data-bs-placement="top" href="#staff-view" class="staff-view-btn action-btn view" data-bs-toggle="modal"
                        ...
                        data-address="{{ $staff->address }}" data-image="{{ asset($staff->image ?? 'assets/img/icon/no-image.svg') }}">
                    ...
                    <a title="{{__('Edit')}}" data-bs-placement="top" href="#staff-edit-modal" class="staff-edit-btn action-btn edit" data-bs-toggle="modal"
                        ...
                        data-address="{{ $staff->address }}" data-image="{{ asset($staff->image ?? 'assets/images/icons/upload.png') }}">
                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
