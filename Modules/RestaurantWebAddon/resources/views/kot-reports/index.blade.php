    ...
    <div class="erp-table-section">
        <div class="container-fluid">
            ...
            <div class="section-title mb-3 d-flex align-items-center justify-content-between flex-wrap">
                ...
                <form action="{{ route('business.kot-reports.index') }}" class="ajax-filter-form" method='GET' table="#kot-reports-data">
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        ...
                        <div class="dropdown custom-dropdown">
                            ...
                            <div class="dropdown-content custom-dropdown-content">
                                <a href="{{ route('business.kot-reports.pdf', request()->all()) }}" class="custom-item export-btn"> {{ __('PDF') }} </a>
                                <a href="{{ route('business.kot-reports.csv', request()->all()) }}" class="custom-item export-btn"> {{ __('CSV') }} </a>
                                <a href="{{ route('business.kot-reports.excel', request()->all()) }}" class="custom-item export-btn"> {{ __('EXCEL') }} </a>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="card" id="kot-reports-data">
                @include('restaurantwebaddon::kot-reports.datas')
            </div>
...
@push('modal')
    @include('restaurantwebaddon::kot-reports.view')
@endpush
