    ...
    <div class="invoice-content invoice-content-size">
        ...
        <div class="mt-2">
            ...
            <div class="company-info">
                <p><span class="invoice-bold">{{ __('Address') }} :</span> {{ $due_collect->business?->address ?? '' }}</p>
                <p><span class="invoice-bold">{{ __('Mobile') }} :</span> {{ $due_collect->business?->phoneNumber ?? '' }}</p>
                ...
                @if (!empty($due_collect->business->vat_name))
                    <p><span class="invoice-bold">{{ $due_collect->business->vat_name }} :</span> {{ $due_collect->business->vat_no ?? '' }}</p>
                @endif
            </div>
        </div>
        ...
        <div class="invoice-info">
            <div>
                ...
                <p><span class="invoice-bold">{{ __('Name') }} :</span> {{ $due_collect->party->name ?? '' }}</p>
